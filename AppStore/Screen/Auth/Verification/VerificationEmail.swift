...
struct VerificationEmail: View {
    ...
    var body: some View {
        VStack {
            ...
            Text("تم ارسال رمز التفعيل الى ايميلك  \(Text(viewModel.phoneNumber).fontWeight(.bold).foregroundColor(.black))")
                .font(.callout)
...
//
//                Button(action: {
//                    viewModel.login(phone: viewModel.phoneNumber) { isSuccess in
//
//                    }
//                }, label: {
//                    Text("اعادة الارسال")
...
//            }
            ...
            Button(action: {
                ...
                viewModel.login(phone: viewModel.phoneNumber, code: code) { Success in
                    goToMainView()
                }
...
struct VerificationEmail_Previews: PreviewProvider {
    static var previews: some View {
        VerificationEmail(viewModel: AuthViewModel())
    }
}
